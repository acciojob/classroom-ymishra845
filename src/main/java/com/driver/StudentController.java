...
public class StudentController {
    ...
    public ResponseEntity<String> addStudentTeacherPair(@RequestParam String student, @RequestParam String teacher){
    	...
    	this.studentService.addStudentTeacherPair(student, teacher);
    ...
    public ResponseEntity<Student> getStudentByName(@PathVariable String name){
        ...
        this.studentService.getStudentByName(name);
    ...
    public ResponseEntity<Teacher> getTeacherByName(@PathVariable String name){
        ...
        this.studentService.getTeacherByName(name);
    ...
    public ResponseEntity<List<String>> getStudentsByTeacherName(@PathVariable String teacher){
        ...
        this.studentService.getStudentsByTeacherName(teacher);
    ...
    public ResponseEntity<String> deleteTeacherByName(@RequestParam String teacher){
    	...
    	this.studentService.deleteTeacherByName(teacher);
